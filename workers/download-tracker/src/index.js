...
<body>
  <h1>VeilLock downloads</h1>
  <p>Render → encrypt → decode locally → display.</p>
  <p><strong>Hosted download:</strong> <a href="/download?asset=veillock-0.1.0.tar.gz">veillock-0.1.0.tar.gz</a></p>
